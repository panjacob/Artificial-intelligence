...
def create_trackbar():
    namedWindow("range")
    createTrackbar("h1", "range", 40, 255, nothing)
    createTrackbar("s1", "range", 40, 255, nothing)
    createTrackbar("v1", "range", 110, 255, nothing)
    createTrackbar("h2", "range", 60, 255, nothing)
    createTrackbar("s2", "range", 60, 255, nothing)
    createTrackbar("v2", "range", 190, 255, nothing)
